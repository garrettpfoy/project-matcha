...
def pairDevices(self, register, CB_ASSET_NUMBER, CB_SERIAL_NUMBER, HS_ASSET_NUMBER, STUDENT_ID):
    ...
    assetNumber = CB_ASSET_NUMBER

    if(REGISTER):
        serialNumber = CB_SERIAL_NUMBER

    hotspotAsset = HS_ASSET_NUMBER
    ...
    try:
        ...
        try:
            assetCell = worksheet.find(CB_SERIAL_NUMBER)
        except:
            print("Neither the serial number or asset number was found!")
            self.updateStatus("Chromebook not found!")
            return
    ...
    self.updateStatus("Successfully connected to Google Sheets, gathering values...")
    self.updateStatus("Pulled MAC... " + macAddress)
    self.updateStatus("Pulled SSID..." + wifiName)
    self.updateStatus("Pulled password..." + wifiPassword)
    ...
    try:
        ...
        self.updateStatus("Task failed at process: INITIAL_PASSWORD_ENTRY")
    ...
    try:
        ...
        try:
            ...
            self.updateStatus("Task failed at process INITIAL_PASSWORD_ENTRY_UNLIKEY")
            driver.quit()
            return
    except:
        self.updateStatus("Password " + LIKELY_PASSWORD + " was accepted")
    ...
    while(isOffline):
        ...
        if(connectionStatus.is_displayed()):
            ...
            self.updateStatus("Task raised an exception at process: CHECK_CONNECTION_STATUS")
            self.updateStatus("This almost always means the webpage is lagging, we will try to connect again momentarily")
    ...
    try:
        ...
        self.updateStatus("Successfully navigated to WifiSettings! Moving on...")
    except:
        self.updateStatus("Task failed at process: NAVIGATE_SETTINGS_BAR")
    ...
    try:
        ...
        self.updateStatus("Successfully set SSID! Moving on...")
    except:
        self.updateStatus("Task failed at process: WIFI_SSID_ENTRY")
    ...
    try:
        if(driver.find_element_by_xpath("//input[@type='password']").is_displayed()):
            ...
            self.updateStatus("Successfully set password! Moving on...")
        else:
        ...
        try:
            self.updateStatus("Password box not found, attempting to resolve...")
            ##Password box is not found
            time.sleep(1)
            driver.implicitly_wait(IMPLICIT_WAIT)
            typeMenu = driver.find_element_by_xpath("/html/body/div[1]/section/section/main/div[2]/div[2]/div/form/div[3]/div/div/div/input")
            ...
            self.updateStatus("Task failed at process: WIFI_PASSWORD_ENTRY")
    ...
    try:
        ...
        applyBox.click()
        self.updateStatus("Successfully saved changes! Moving on...")
    except:
        try:
            driver.implicitly_wait(IMPLICIT_WAIT)
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        self.updateStatus("Task failed at process: WIFI_SAVE_CHANGES")
    ...
    try:
        ...
        confirmBox.click()
        self.updateStatus("Successfully confirmed changes! Moving on...")
    except:
        try:
            driver.implicitly_wait(IMPLICIT_WAIT)
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        self.updateStatus("Task failed at process: WIFI_CONFIRM_CHANGES")
    ...
    if(unlikelyPassword and FIX_PASSWORD):
        try:
            ...
            self.updateStatus("Task failed at process: UNLIKELY_PASSWORD_ENTRY")
            driver.quit()
            return
        ...
        try:
            ...
            self.updateStatus("Task failed at process: LIKELY_PASSWORD_ENTRY_INITIAL")
            driver.quit()
            return
        ...
        try:
            ...
            self.updateStatus("Task failed at process: LIKELY_PASSWORD_ENTRY_CONFIRM")
            driver.quit()
            return
        ...
        try:
            ...
            self.updateStatus("Task failed at process: PASSWORD_CHANGE_CONFIRM")
            driver.quit()
            return
    ...
    try:
        ...
        apnSelector.click()
        self.updateStatus("Successfully selected the APN dropdown! Moving on...")
    except:
        self.updateStatus("Task failed at process: APN_DROPDOWN_SELECT")
    ...
    try:
        ...
        TMobile.click()
        self.updateStatus("Successfully selected T-MOBILE from dropdown! Moving on...")
    except:
        try:
            ...
            self.updateStatus("Task failed at process: APN_PROFILE_SELECT")
    ...
    try:
        ...
        try:
            ...
            self.updateStatus("APN Confirm was not selected (not an error)")
    ...
    try:
        if((driver.find_element_by_xpath("//div[2]/div/div/input").is_displayed()) == False):
            ...
            dropdownMAC.click()
            self.updateStatus("Successfully selected MAC dropdown! Moving on...")
            driver.implicitly_wait(2)
            whitelist = driver.find_element_by_xpath("/html/body/div[3]/div[1]/div[1]/ul/li[2]")
            whitelist.click()
            self.updateStatus("Successfully selected whitelist from MAC dropdown! Moving on...")
    except:
        self.updateStatus("Task failed at process: MAC_DROPDOWN_SELECT")
    ...
    try:
        ...
        self.updateStatus("Successfully added student MAC (asset)! Moving on...")
        time.sleep(0.5)
    except:
        self.updateStatus("Task failed at process: MAC_ADD_STUDENTID")
    ...
    try:
        ...
        self.updateStatus("Successfully added student MAC (address)! Moving on...")
        time.sleep(0.5)
    except:
        self.updateStatus("Task failed at process: MAC_ADD_STUDENTADDY")
    ...
    try:
        ...
        submitStudent.click()
        self.updateStatus("Successfully saved student MAC credentials! Moving on...")
        time.sleep(0.5)
    except:
        self.updateStatus("Task failed at process: MAC_ADD_STUDENT")
    ...
    try:
        ...
        self.updateStatus("MAC Address was added successfully (not a duplicate)")
    ...
    #    time.sleep(0.5)
    #    nicknameAdminOne.send_keys("A000031388")
    #    self.updateStatus("Successfully added first admin MAC (asset)! Moving on...")
    #except:
    #    self.updateStatus("Task failed at process: MAC_ADMIN_ADDID_ONE")
    ...
    #    addressAdminOne.send_keys("d4:d2:52:55:2f:a8")
    #    self.updateStatus("Successfully added first admin MAC (address)! Moving on...")
    #    time.sleep(0.5)
    #except:
    #    self.updateStatus("Task failed at process: MAC_ADMIN_ADDMAC_ONE")
    ...
    #    self.updateStatus("Successfully added first admin MAC credentials! Moving on...")
    #    time.sleep(0.5)
    #except:
    #    self.updateStatus("Task failed at process: MAC_ADMIN_ADD_ONE")
    ...
    #    nicknameAdminTwo.send_keys("A000060098")
    #    self.updateStatus("Successfully added second MAC (asset)! Moving on...")
    #    time.sleep(0.5)
    #except:
    #    self.updateStatus("Task failed at process: MAC_ADD_ADMINID_TWO")
    ...
    #    addressAdminTwo.send_keys("48:89:e7:03:34:b9")
    #    self.updateStatus("Successfully added second MAC (address)! Moving on...")
    #    time.sleep(0.5)
    #except:
    #    self.updateStatus("Task failed at process: MAC_ADD_ADMINMAC_TWO")
    ...
    #    self.updateStatus("Successfully added second MAC credentials! Moving on...")
    #    time.sleep(0.5)
    #except:
    #    self.updateStatus("Task failed at process: MAC_ADD_ADMIN_TWO")
    ...
    self.updateStatus("Success! The script has completed!")
    driver.quit()
